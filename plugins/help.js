...
if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
    ...
    Asena.newcmdaddtosew({pattern: 'phelp ?(.*)', fromMe: true, desc: h_Des}, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({pattern: 'phelp ?(.*)', fromMe: true, desc: h_DedEN}, (async (message, match) => {
