...
if (isuru.LANG == 'SI') {
 ...
 if (isuru.PSW !== 'kingraviya') {
if (isuru.WORKTYPE == 'private') {
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'deepai$', fromMe: true, delownsewcmd: false, desc: Lang.DEEPAI_DESC}, (async (message, match) => {
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'faceai$', fromMe: true, delownsewcmd: false, dontAdCommandList: true }, (async (message, match) => {
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'animai', fromMe: true, delownsewcmd: false, dontAdCommandList: true }, (async (message, match) => {
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'colorai$', fromMe: true, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {    
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'waifuai$', fromMe: true, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {  
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'superai$', fromMe: true, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {  
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'moodai ?(.*)', fromMe: true, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'dreamai$', fromMe: true, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {   
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI); 
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'neuraltalkai$', fromMe: true, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {   
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'ttiai ?(.*)', fromMe: true, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (match[1] === '') return await message.sendMessage(Lang.TEXT);
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'toonai$', fromMe: true, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {   
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'nudityai$', fromMe: true, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {  
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'textai ?(.*)', fromMe: true, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (match[1] === '') return await message.sendMessage(Lang.TEXT);
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'ganstyle$', fromMe: true, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {  
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI); 
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'deepai$', fromMe: false, delownsewcmd: false, desc: Lang.DEEPAI_DESC}, (async (message, match) => {
        
            await message.sendMessage('❄ Command: *.moodai <text>*\n✨ Discretion: It finds your mood from the article you wrote.\n\n❄ Command: *.colorai*\n✨ Discretion: It colorize bw photos.\n\n❄ Command: *.faceai*\n✨ Discretion: Generates human faces with artificial intelligence, that never existed before.\n\n❄ Command: *.animai*\n✨ Discretion: Generates anime faces with artificial intelligence, that never existed before.\n\n❄ Command: *.superai*\n✨ Discretion: Improves the quality of photos with Neural AI.\n\n❄ Command: *.waifuai*\n✨ Discretion: Combines the color palettes of photos with artificial intelligence.\n\n❄ Command: *.dreamai*\n✨ Discretion: Applies deepdream effect to the photo.\n\n❄ Command: *.neuraltalkai*\n✨ Discretion: Explain the phenomenon in the photo with artificial intelligence.\n\n❄ Command: *.ttiai <text>*\n✨ Discretion: Converts text to a picture. (Text-to-Image)\n\n❄ Command: *.toonai*\n✨ Discretion: Turns the face in the photo into a cartoon character.\n\n❄ Command: *.textai <text>*\n✨ Discretion: It creates an artificial story for you from your sentence.\n\n❄ Command: *.nudityai*\n✨ Discretion: It shows the NSFW value between 1 and 0 in the photo.\n\n❄ Command: *.ganstyle*\n✨ Discretion: Combines the photo you answered with the selected picture.\n\n⚠️ 🇬🇧 *All the tools here work with deep learning. The more you use it, the more information it stores.* ```Use only english characters!```\n\nᴘᴏᴡᴇʀᴅ ʙʏ ꜱᴇᴡ ǫᴜᴇᴇɴ');
        
    }));
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'faceai$', fromMe: false, delownsewcmd: false, dontAdCommandList: true }, (async (message, match) => {
        var image_an = await Pach.face()
        var webimage = await axios.get(image_an, {responseType: 'arraybuffer'})
        await message.sendMessage(Buffer.from(webimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: isuru.CPK})
    }));
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'animai', fromMe: false, delownsewcmd: false, dontAdCommandList: true }, (async (message, match) => {
        var anim_img = await Pach.anime()
        var IMGWADATA = await axios.get(anim_img, {responseType: 'arraybuffer'})
        await message.sendMessage(
            Buffer.from(IMGWADATA.data),
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'colorai$', fromMe: false, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => { 
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);   
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
        var downloading = await message.client.sendMessage(message.jid,'Colorizing.. 🎨',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'waifuai$', fromMe: false, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {  
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
        var downloading = await message.client.sendMessage(message.jid,'Mixing.. 🧩',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'superai$', fromMe: false, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);  
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
        var downloading = await message.client.sendMessage(message.jid,'Enhancing.. 🖌️',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'moodai ?(.*)', fromMe: false, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (match[1] === '') return await message.sendMessage(Lang.TEXT);
        var msgdata = await Pach.mood(match[1], isuru.DEEPAI)
        var resp = await deepai.callStandardApi("sentiment-analysis", {
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'dreamai$', fromMe: false, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {    
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
        var downloading = await message.client.sendMessage(message.jid,'Starry Night.. 🌃',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'neuraltalkai$', fromMe: false, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {   
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
        var downloading = await message.client.sendMessage(message.jid,'Reading.. 🙇🏻',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'ttiai ?(.*)', fromMe: false, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (match[1] === '') return await message.sendMessage(Lang.TEXT);
        var msg_tt = await Pach.tti(match[1], isuru.DEEPAI)
        var resp = await deepai.callStandardApi("text2img", {
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'toonai$', fromMe: false, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {   
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
        var downloading = await message.client.sendMessage(message.jid,'Tooning.. 🌟',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'nudityai$', fromMe: false, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {  
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
        var downloading = await message.client.sendMessage(message.jid,'Finding NSFW.. 🔥',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'textai ?(.*)', fromMe: false, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (match[1] === '') return await message.sendMessage(Lang.TEXT);
        var text_ai = await Pach.text(match[1], isuru.DEEPAI)
        var resp = await deepai.callStandardApi("text-generator", {
    ...
    ᴋɪɴɢɪꜱᴜᴡᴀ.newcmdaddtosew({pattern: 'ganstyle$', fromMe: false, delownsewcmd: false, dontAdCommandList: true}, (async (message, match) => {   
        if (!isuru.DEEPAI) return await message.sendMessage(noAPI);
        if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
        var downloading = await message.client.sendMessage(message.jid,'Creating.. ♻️',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
